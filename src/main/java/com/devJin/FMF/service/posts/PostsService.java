...
public class PostsService {
    ...
    @org.springframework.transaction.annotation.Transactional(readOnly = true) // 트랙잭션 어노테이션에 readOnly 옵션을 주면 트랜잭션 범위는 유지하되, 조회기능만 남겨두어 조회 속도가 개션됨 -> 등록 수정 삭제 기능이 없는 서비스 메소드에서 사용 추천
